...
const ServicePageProject = () => {
    return (
        <div className='bg-black opacity-85 space-y-8 xl:p-20 p-4'>
            <h1 className='text-4xl font-bold text-white text-center'>Our Project</h1>
            <p className='text-center text-white'>We have successfully led these UI/UX projects, implementing innovative design solutions that enhance user experiences and streamline interactions.</p>
...
export default ServicePageProject
