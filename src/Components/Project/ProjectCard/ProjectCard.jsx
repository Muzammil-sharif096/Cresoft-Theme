...
const ProjectCard = () => {
    return (
        <>
            <div className='2xl:p-20 p-4 bg-black space-y-6'>
                ...
                <ul className='text-white 2xl:flex flex-wrap space-y-5 2xl:space-y-0 list-none justify-center gap-8'>
                    <li className='2xl:px-8 2xl:py-3 py-2 px-3 bg-[#63B597] rounded-xl font-bold'>All</li>
                    <li className='2xl:px-8 2xl:py-3 py-2 px-3 bg-gray-800 hover:bg-[#63B597] hover:text-black rounded-xl font-bold'>AI Development</li>
                    <li className='2xl:px-8 2xl:py-3 py-2 px-3 bg-gray-800 hover:bg-[#63B597] hover:text-black rounded-xl font-bold'>Blockchain Development</li>
                    <li className='2xl:px-8 2xl:py-3 py-2 px-3 bg-gray-800 hover:bg-[#63B597] hover:text-black rounded-xl font-bold'>Web Development</li>
                    <li className='2xl:px-8 2xl:py-3 py-2 px-3 bg-gray-800 hover:bg-[#63B597] hover:text-black rounded-xl font-bold'>App Development</li>
                    <li className='2xl:px-8 2xl:py-3 py-2 px-3 bg-gray-800 hover:bg-[#63B597] hover:text-black rounded-xl font-bold'>UI/UX Design</li>
                </ul>
