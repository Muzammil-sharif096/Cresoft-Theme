                        ...
                        </button>
                        {
                            showDiv1 && (
                                <div className='flex justify-center items-center h-screen absolute left-1/2'>
                                    ...
                                    <div className='bg-black fixed top-5 2xl:p-20 px-3 py-6 2xl:w-1/2 w-full space-y-1  h-[calc(100vh-40px)] overflow-auto rounded-lg z-50'>
                                        ...
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni quia in dolor sint, culpa excepturi neque reiciendis aliquid laborum ipsum? Quidem earum enim perspiciatis harum, praesentium obcaecati porro necessitatibus doloremque illo inventore numquam? Rem quidem quibusdam consectetur, suscipit commodi reiciendis eaque laboriosam impedit velit repudiandae error at accusamus aspernatur ipsa.</p>
                                    </div>
                                </div>
                            )
                        }
        ...
        w-0 h-0 transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:w-full group-hover:h-full'
                        ...
                        </button>
                        {
                            showDiv2 && (
                                <div className='flex justify-center items-center h-screen absolute left-1/2'>
                                    <div className='fixed top-0 left-0 w-full h-full bg-gray-900 opacity-50 z-50'></div>
                                    <div className='bg-black overflow-auto fixed top-5 2xl:p-20 p-5 2xl:w-1/2 w-full space-y-1 h-[calc(100vh-40px)] rounded-lg z-50'>
        ...
        w-0 h-0 transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:w-full group-hover:h-full'
                        ...
                        </button>
                        {
                            showDiv3 && (
                                <div className='flex justify-center items-center h-screen absolute left-1/2'>
                                    <div className='fixed top-0 left-0 w-full h-full bg-gray-900 opacity-50 z-50'></div>
                                    <div className='bg-black fixed overflow-auto top-5 2xl:p-20 p-5 2xl:w-1/2 w-full space-y-1 h-[calc(100vh-40px)] rounded-lg z-50'>
